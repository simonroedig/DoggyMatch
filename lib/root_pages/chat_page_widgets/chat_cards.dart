...
// Import the FriendIconWidget and SaveIconWidget
...
class _ChatCardState extends State<ChatCard> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    // Remove the FutureBuilder and extract available data
              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    ...
                    // Friend Icon using FriendIconWidget
                    Positioned(
                      bottom: -4,
                      left: -4,
                      child: FriendIconWidget(
                        userId: widget.otherUserProfile.uid,
                          ...
                          builder: (context, seenSnapshot) {
                            ...
                            return ValueListenableBuilder<LastMessage>(
                              ...
                              builder: (context, lastMessage, child) {
                                ...
                                final bool isIncoming = lastMessage.senderId !=
